 ...
 */
public class PullRereshRecycleView extends RecyclerView {
    /**
     * 是否可以刷新的常量
     */
    ...
    public PullRereshRecycleView(Context context) {
        this(context, null);
    }

    public PullRereshRecycleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PullRereshRecycleView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == emptyCount) {
                    ...
                    PullRereshRecycleView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    PullRereshRecycleView.this.setVisibility(View.VISIBLE);
                }
            }
