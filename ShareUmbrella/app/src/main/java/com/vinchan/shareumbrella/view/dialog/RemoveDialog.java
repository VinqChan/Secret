...
public class RemoveDialog extends BaseDialog {
     ...
     */
    public RemoveDialog(Activity context) {
     ...
     * @param width      自定义宽度
     */
    public RemoveDialog(Activity context, int width) {
        super(context);
    ...
    public void initView() {
        super.initView();
        customView = LayoutInflater.from(context).inflate(R.layout.dialog_remove, null);
        getWindow().setContentView(customView);

        codeTv = customView.findViewById(R.id.code_tv);
        shopNameTv = customView.findViewById(R.id.shop_name_tv);
        siteNameTv = customView.findViewById(R.id.site_name_tv);
