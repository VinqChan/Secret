...
public class WallteAdapter extends RecyclerView.Adapter {
    ...
    public WallteAdapter(List<OrderDetail.OrderDetailItem> listData, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_HEADER) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.item_wallet_list_header, parent, false);
