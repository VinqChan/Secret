package com.dangong.oksan.wxapi;

/**
 * Created by Jian on 2018/6/15.
 */
...
public class WechatShareManager {
    ...
    private void initWechatShare(Context context) {
        if (mWXApi == null) {
            mWXApi = WXAPIFactory.createWXAPI(context, App.WECHAT_APP_ID, true);
        }
        mWXApi.registerApp(App.WECHAT_APP_ID);
    }
    ...
    private void shareVideo(ShareContent shareContent, int shareType) {
        ...
        msg.title = shareContent.getTitle();
        msg.description = shareContent.getContent();
        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.ic_bj_czdz);
