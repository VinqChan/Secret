...
public class ManagerPersonCenterActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_manager_person_center;
    }
    ...
    @OnClick({R.id.custom_header_view, R.id.history_rl,  R.id.gift_shop_rl, R.id.help_rl, R.id.guide_rl, R.id.setting_rl, R.id.wechat_rl})
